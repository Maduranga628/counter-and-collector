...
#define SEG_D2_Pin GPIO_PIN_0
#define SEG_D2_GPIO_Port GPIOB
#define SEG_D3_Pin GPIO_PIN_1
#define SEG_D3_GPIO_Port GPIOB
#define INC_BTN_Pin GPIO_PIN_12
#define INC_BTN_GPIO_Port GPIOB
#define INC_BTN_EXTI_IRQn EXTI15_10_IRQn
#define CLR_BTN_Pin GPIO_PIN_14
#define CLR_BTN_GPIO_Port GPIOB
#define CLR_BTN_EXTI_IRQn EXTI15_10_IRQn
...
#define SEG_D4_Pin GPIO_PIN_4
#define SEG_D4_GPIO_Port GPIOB
#define RST_BTN_Pin GPIO_PIN_9
#define RST_BTN_GPIO_Port GPIOB
#define RST_BTN_EXTI_IRQn EXTI9_5_IRQn
